...
public abstract class ApplicationSubmissionContext {
   ...
   *
   * @param priority
   *     <code>Priority</code> of the application
   */
  @Private
  @Unstable
   ...
   * AM to be launched and connect to the RM within the AM liveliness period
   * and
   ...
   *
   * @param cancel
   *     true if tokens should be canceled when the app finishes.
   */
  @LimitedPrivate("mapreduce")
  @Unstable
   ...
   * application
   * attempt fails and these containers will be retrieved by the new
   * application
